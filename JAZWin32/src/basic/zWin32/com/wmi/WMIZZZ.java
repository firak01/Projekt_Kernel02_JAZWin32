...
public class WMIZZZ extends AbstractObjectWithFlagZZZ{
	private ActiveXComponent objWMIService = null;
	
	public WMIZZZ() throws ExceptionZZZ {
		super();
		WMINew_(null);
	}
	
	public WMIZZZ(String[] saFlagControl) throws ExceptionZZZ{
		super();
		WMINew_(saFlagControl);
	}
	
	private void WMINew_(String[] saFlagControl) throws ExceptionZZZ{
